  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto w-full max-w-6xl px-6 pb-20 pt-10 sm:pt-16">
        <section className="relative overflow-hidden rounded-4xl border border-black/10 bg-white/70 px-6 py-12 shadow-(--shadow) backdrop-blur sm:px-10 md:px-14 md:py-16">
